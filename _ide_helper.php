...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function stWhere($magellanExpression, $operator = null, $value = null, $boolean = 'and')
        {
                        return \Illuminate\Database\Query\Builder::stWhere($magellanExpression, $operator, $value, $boolean);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function stOrWhere($magellanExpression, $operator = null, $value = null)
        {
                        return \Illuminate\Database\Query\Builder::stOrWhere($magellanExpression, $operator, $value);
        }
                    /**
         * 
         *
...
namespace  { 
            ...
            public static function stWhere($magellanExpression, $operator = null, $value = null, $boolean = 'and')
            {
                                return \Illuminate\Database\Eloquent\Builder::stWhere($magellanExpression, $operator, $value, $boolean);
            }
            ...
            public static function stOrWhere($magellanExpression, $operator = null, $value = null)
            {
                                return \Illuminate\Database\Eloquent\Builder::stOrWhere($magellanExpression, $operator, $value);
            }
