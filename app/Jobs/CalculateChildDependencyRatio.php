...
use App\Models\ChildDependencyRatio;
use Exception;
 ...
 */
class CalculateChildDependencyRatio implements ShouldQueue
{
            ...
            ->chunk(200, function ($referenceGeometries) {
                ...
                foreach ($referenceGeometries as $feature) {
                    try {
                        ...
                        Log::info('Child Dependency Ratio calculation completed successfully.');
                ...
                DB::transaction(function () use ($resultsToInsert) {
                    ChildDependencyRatio::insert($resultsToInsert);
                });
            });
    }
