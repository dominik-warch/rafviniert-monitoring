<x-app-layout>
    <form action="{{ route('import.addresses.store') }}" method="post" enctype="multipart/form-data">
        @csrf

        <div class="space-y-12 sm:space-y-16">
            <div>
                <h2 class="text-base font-semibold leading-7 text-gray-900">Import von Adressen</h2>
                <p class="mt-1 text-sm leading-6 text-gray-600">Zur lokalen Geokodierung.
                </p>
